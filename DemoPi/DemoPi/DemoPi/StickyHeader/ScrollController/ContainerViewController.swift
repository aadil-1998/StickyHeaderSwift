...
//        if let vc = bottomVC as? CollegeDetailBottomVC {
//            if let vcG: CollegeGalleryVC = vc.vwPageController.arrViewController[vc.selectedIndex] as? CollegeGalleryVC {
//                vcG.colList.setContentOffset(.zero, animated: false)
//                vcG.colList.isScrollEnabled = true
//            }
//        }
